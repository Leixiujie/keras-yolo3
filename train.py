...
def _main():
    ...
    if is_tiny_version:
        model = create_tiny_model(input_shape, anchors, num_classes,
            freeze_body=2, weights_path='E:/津南数字制造算法挑战赛/keras-yolo3/logs/000/trained_weights_final.h5')
    else:
        model = create_model(input_shape, anchors, num_classes,
            freeze_body=2, weights_path='E:/津南数字制造算法挑战赛/keras-yolo3/logs/000/trained_weights_final.h5') # make sure you know what you freeze
    ...
    if True:
        model.load_weights('E:/津南数字制造算法挑战赛/keras-yolo3/logs/000/trained_weights_final.h5')
...
def create_model(input_shape, anchors, num_classes, load_pretrained=False, freeze_body=2,
            weights_path='E:/津南数字制造算法挑战赛/keras-yolo3/logs/000/ep033-loss55.035-val_loss48.441.h5'):
